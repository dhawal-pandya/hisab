...
function App() {
  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center py-8 bg-gray-900 text-gray-100">
      <h1 className="text-5xl font-extrabold mb-8 text-green-500 tracking-tight leading-tight text-center">
        Hisab
      </h1>
